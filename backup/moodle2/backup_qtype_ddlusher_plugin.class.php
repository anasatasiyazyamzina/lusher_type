...
/**
 * Backup code for qtype_ddlusher.
 *
...
/**
 * Provides the information to backup ddlusher questions.
 *
 * @copyright 2011 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qtype_ddlusher_plugin extends backup_qtype_plugin {
    /**
     * Returns the question type this is.
     *
     * @return string question type name, like 'ddlusher'.
     */
