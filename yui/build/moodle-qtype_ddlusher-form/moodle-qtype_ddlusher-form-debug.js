YUI.add('moodle-qtype_ddlusher-form', function(Y, NAME) {
     ...
     */
    var ddlusherFORMNAME = 'moodle-qtype_ddlusher-form';
    var ddlusher_FORM = function() {
        ddlusher_FORM.superclass.constructor.apply(this, arguments);
    };

    Y.extend(ddlusher_FORM, M.qtype_ddlusher.dd_base_class, {
        pendingid: '',
        fp: null,

        initializer: function() {
            this.pendingid = 'qtype_ddlusher-form-' + Math.random().toString(36).slice(2); // Random string.
    ...
    }, { NAME: ddlusherFORMNAME, ATTRS: { maxsizes: { value: null } } });
    M.qtype_ddlusher = M.qtype_ddlusher || {};
    M.qtype_ddlusher.init_form = function(config) {
        return new ddlusher_FORM(config);
    };
