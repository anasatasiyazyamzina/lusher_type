 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ddtoimgLusher_renderer_base extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        $img = html_writer::empty_tag('img', array(
                ...
                'alt' => get_string('dropbackground', 'qtype_ddlusher')));
        ...
        $PAGE->requires->string_for_js('blank', 'qtype_ddlusher');
        $PAGE->requires->yui_module('moodle-qtype_ddlusher-dd',
                                        'M.qtype_ddlusher.init_question',
                                        array($params));
